...
export default function WorldCupReport({ lang, onBack }: WorldCupReportProps) {
  ...
  const t = {
    en: {
      metaReport: "FIFA World Cup 2026 · Market Intelligence Report",
      tag: "Live Analysis",
      ...
      algeriaPoints: "Algeria — Group J Final Points",
      algeriaPointsSub: "Goal difference +1 · Runner-up finish",
      ...
      groupFocus: "Group J · Primary Focus",
      algeriaCampaign: "Algeria's Group-Stage Campaign",
      ...
      moroccoFocus: "Group C · Top Contender",
      ...
      summaryFocus: "Group Stage Summary",
      ...
      contingentBody3: "Saudi Arabia, three years removed from their extraordinary victory over Argentina in Qatar, face Spain and Uruguay in Group H. Their projected probability of 30–45% reflects both the difficulty of the draw and the capability they possess for producing results against odds — a trait they have demonstrated on football's biggest stage. Tunisia (Group F, 35–45%), Qatar (Group B, 20–35%), Iraq (Group I, 15–25%), and Jordan (Group J, eliminated) complete the picture of a region that has sent its most ambitious, most experienced delegation to a World Cup finals.",
      colTeam: "Team",
      colGroup: "Group",
      colQual: "Qualification Probability",
      colProj: "Projected Points",
      sidebarQualTitle: "Qualification Probability",
      sidebarBreakdown: "Algeria — Qual. Breakdown",
      sidebarAsRunnerUp: "As Group Runner-Up (2nd)",
      sidebarAsBestThird: "As Best 3rd-Placed Team",
      sidebarElim: "Elimination Probability",
      sidebarBreakdownNote: "Based on 4 points, GD +1, and 4 goals scored across Group J fixtures.",
      sidebarModel: "DZ Analytica Model",
      ...
      overviewFocus: "All Arab Participants",
      ...
      conclusionP2: "Algeria's disciplined qualification from Group J — built on four points, a positive goal difference, and the maturity to hold their nerve against Argentina — represents the most measured, methodical performance an Arab side has produced in the group stage since Morocco's own 2022 campaign. DZ Analytica's cumulative qualification probability of approximately 90% reflects not just favorable arithmetic, but genuine competitive growth.",
      conclusionP3: "Together, eight Arab nations enter the knockout rounds with aspirations that extend well beyond participation. The global game is witnessing a structural shift in where football's next chapter will be written — and increasingly, it is being written in Arabic.",
      disclaimer: "Report published June 12, 2026 · All projections are analytical estimates and may differ from actual results.",
      loss: "Loss",
      draw: "Draw",
      win: "Win",
    ...
    ar: {
      metaReport: "كأس العالم FIFA 2026 · تقرير استخبارات السوق",
      tag: "تحليل مباشر",
      ...
      algeriaPoints: "الجزائر — النقاط النهائية للمجموعة العاشرة",
      algeriaPointsSub: "فارق الأهداف +1 · إنهاء في المركز الثاني",
      ...
      introP2: "يتوقع تحليل دور المجموعات من دزاير أناليتيكا أن تكون الجزائر صاحبة الأداء الأبرز بين المنتخبات العربية، بالتأهل من المجموعة العاشرة بأربع نقاط وفارق أهداف إيجابي. إن مسيرة محاربي الصحراء المنضبطة — خسارة ضيقة أمام الأرجنتين، تعادل حاسم مع النمسا، وفوز مقنع على الأردن — تضعهم كتهديد حقيقي في الأدوار الإقصائية.",
      introP3: "يكمل المغرب ومصر والمملكة العربية السعودية وتونس وقطر والعراق والأردن هذه المجموعة التي تمثل بشكل جماعي المكانة المتنامية لكرة القدم العربية في اللعبة العالمية. يوضح هذا التقرير أداء كل فريق في دور المجموعات، واحتمال تأهله، والآثار الاقتصادية الأوسع للوجود القياسي للمنطقة في نهائيات كأس العالم.",
      groupFocus: "المجموعة العاشرة · التركيز الأساسي",
      algeriaCampaign: "مسيرة الجزائر في دور المجموعات",
      ...
      moroccoFocus: "المجموعة الثالثة · المنافس الأبرز",
      ...
      summaryFocus: "ملخص دور المجموعات",
      ...
      colTeam: "المنتخب",
      colGroup: "المجموعة",
      colQual: "احتمالية التأهل",
      colProj: "النقاط المتوقعة",
      sidebarQualTitle: "احتمالية التأهل للنهائيات",
      sidebarBreakdown: "تفصيل تأهل الجزائر",
      sidebarAsRunnerUp: "كوصيف المجموعة (الثاني)",
      sidebarAsBestThird: "كأحد أفضل الثوالث",
      sidebarElim: "احتمال الإقصاء",
      sidebarBreakdownNote: "بناءً على 4 نقاط، فارق أهداف +1، و 4 أهداف مسجلة في المجموعة العاشرة.",
      ...
      overviewFocus: "جميع المشاركين العرب",
      ...
      conclusionP2: "يمثل تأهل الجزائر المنضبط عن المجموعة العاشرة — المبني على أربع نقاط وفارق أهداف إيجابي والنضج في الصمود أمام الأرجنتين — الأداء الأكثر توازناً ومنهجية لمنتخب عربي في دور المجموعات منذ مسيرة المغرب في 2022. يعكس احتمال التأهل التراكمي البالغ حوالي 90% نمواً تنافسياً حقيقياً.",
      conclusionP3: "معاً، تدخل ثمانية منتخبات عربية الأدوار الإقصائية بتطلعات تتجاوز مجرد المشاركة الشرفية. تشهد اللعبة العالمية تحولاً هيكلياً في كتابة فصولها القادمة — وبشكل متزايد، تكتب هذه الفصول باللغة العربية.",
      disclaimer: "تم نشر التقرير في 12 يونيو 2026 · جميع التوقعات هي تقديرات تحليلية وقد تختلف عن النتائج الفعلية.",
      loss: "خسارة",
      draw: "تعادل",
      win: "فوز",
      eliminated: "مغادر",
    ...
    fr: {
      metaReport: "Coupe du Monde de la FIFA 2026 · Rapport d'Intelligence de Marché",
      ...
      algeriaPoints: "Algérie — Points Finaux du Groupe J",
      algeriaPointsSub: "Différence de buts +1 · Deuxième place",
      ...
      introP1: "La Coupe du Monde de la FIFA 2026 marque un chapitre extraordinaire dans l'histoire du football arabe. Avec l'expansion du tournoi à 48 équipes et son organisation aux États-Unis, au Canada et au Mexique, un record de huit nations arabes ont assuré leur place sur la plus grande scène du football. Après la demi-finale historique du Maroc au Qatar 2022, les attentes dans la région n'ont jamais été aussi élevées.",
      introP2: "L'analyse de la phase de groupes de DZ Analytica projette l'Algérie comme le performeur marquant parmi les équipes arabes, se qualifiant du Groupe J avec quatre points et une différence de buts positive. La campagne disciplinée des Fennecs — une défaite étroite contre l'Argentine, un match nul crucial avec l'Autriche et une victoire convaincante contre la Jordanie — les positionne comme une menace sérieuse pour les phases à élimination directe.",
      ...
      groupFocus: "Groupe J · Focus Principal",
      algeriaCampaign: "Campagne de phase de groupes de l'Algérie",
      ...
      moroccoFocus: "Groupe C · Top Contendeur",
      ...
      summaryFocus: "Résumé de la Phase de Groupes",
      ...
      colTeam: "Équipe",
      colGroup: "Groupe",
      colQual: "Probabilité de Qualification",
      colProj: "Points Projetés",
      sidebarQualTitle: "Probabilité de Qualification",
      sidebarBreakdown: "Algérie — Détails de Qual.",
      sidebarAsRunnerUp: "En tant que 2e du Groupe",
      sidebarAsBestThird: "En tant que meilleur 3e",
      sidebarElim: "Probabilité d'Élimination",
      sidebarBreakdownNote: "Basé sur 4 points, différence de buts de +1, et 4 buts marqués dans le Groupe J.",
      ...
      overviewFocus: "Tous les participants arabes",
      ...
      conclusionP2: "La qualification de l'Algérie dans le Groupe J — construite sur quatre points, une différence de buts positive et le sang-froid face à l'Argentine — représente la performance la plus méthodique d'une équipe arabe en phase de groupes depuis le Maroc en 2022. La probabilité cumulative d'environ 90% reflète une croissance compétitive.",
      conclusionP3: "Ensemble, huit nations arabes abordent les phases éliminatoires avec des ambitions qui s'étendent bien au-delà de la participation. Le football mondial assiste à un virage structurel majeur, et de plus en plus, le nouveau chapitre s'écrit en arabe.",
      disclaimer: "Rapport publié le 12 juin 2026 · Les projections sont des estimations analytiques et peuvent différer des résultats réels.",
      loss: "Défaite",
      draw: "Nul",
      win: "Victoire",
      eliminated: "Éliminé",
  ...
  const teamCards = [
    { flag: "🇩🇿", name: { en: "Algeria", ar: "الجزائر", fr: "Algérie" }, group: "Group J", prob: "~90%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "Strong Round of 32 candidate. 4 pts, +1 GD. Qualified as group runner-up.", ar: "مرشح قوي لدور الـ 32. 4 نقاط، فارق أهداف +1. تأهل كوصيف للمجموعة.", fr: "Fort candidat pour les 16es de finale. 4 pts, +1 GD. Qualifié en tant que 2e du groupe." }, color: "high" },
    { flag: "🇲🇦", name: { en: "Morocco", ar: "المغرب", fr: "Maroc" }, group: "Group C", prob: "75–85%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "Regional benchmark. Contender for Round of 16 and beyond following 2022 heroics.", ar: "المعيار المرجعي للمنطقة. مرشح لدور الـ 16 وما بعده بعد إنجازات 2022.", fr: "Référence régionale. Contendant pour les 8es de finale et au-delà après les exploits de 2022." }, color: "high" },
    { flag: "🇪🇬", name: { en: "Egypt", ar: "مصر", fr: "Égypte" }, group: "Group G", prob: "40–55%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "Seeking first knockout qualification in decades. Capable of challenging Belgium for second.", ar: "يسعى للتأهل للأدوار الإقصائية للمرة الأولى منذ عقود. قادر على منافسة بلجيكا على الوصافة.", fr: "Cherche sa première qualification en phase finale depuis des décennies. Capable de défier la Belgique." }, color: "mid" },
    { flag: "🇹🇳", name: { en: "Tunisia", ar: "تونس", fr: "Tunisie" }, group: "Group F", prob: "35–45%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "Competitive but difficult draw. Every point will be crucial against Netherlands and Japan.", ar: "قرعة تنافسية وصعبة. كل نقطة ستكون حاسمة أمام هولندا واليابان.", fr: "Tirage compétitif mais difficile. Chaque point sera crucial contre les Pays-Bas et le Japon." }, color: "mid" },
    { flag: "🇸🇦", name: { en: "Saudi Arabia", ar: "السعودية", fr: "Arabie Saoudite" }, group: "Group H", prob: "30–45%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "Proven capacity for upsets. Faces Spain and Uruguay in a demanding group.", ar: "قدرة مثبتة على إحداث المفاجآت. يواجه إسبانيا والأوروغواي في مجموعة قوية.", fr: "Capacité avérée à créer des surprises. Affronte l'Espagne et l'Uruguay dans un groupe exigeant." }, color: "mid" },
    ...
    { flag: "🇮🇶", name: { en: "Iraq", ar: "العراق", fr: "Irak" }, group: "Group I", prob: "15–25%", probLabel: isRtl ? "احتمالية التأهل" : "qualification probability", outlook: { en: "One of the toughest draws: France, Senegal, Norway. Valuable experience for a developing side.", ar: "واحدة من أصعب المجموعات: فرنسا، السنغال، النرويج. تجربة قيمة لفريق يتطور.", fr: "Un des tirages les plus durs : France, Sénégal, Norvège. Expérience précieuse pour un groupe en développement." }, color: "low" },
    { flag: "🇯🇴", name: { en: "Jordan", ar: "الأردن", fr: "Jordanie" }, group: "Group J", prob: currentT.eliminated, probLabel: "0 pts, GD -3", outlook: { en: "Developmental tournament. Experience gained will prove invaluable for future qualifying campaigns.", ar: "بطولة تطويرية وتجربة قيمة ستكون حاسمة في تصفيات كأس العالم القادمة.", fr: "Tournoi d'apprentissage. L'expérience acquise s'avérera précieuse pour les futures campagnes." }, color: "low" }
  ];

  return (
    <div className="world-cup-report-page">
      {/* Dynamic Font and Style Injection for exact replication */}
      <style>{`
      ...
      <div className="report-back-bar">
        ...
        <div className="wcr-footer-copy">
          {lang === 'ar' ? '١٢ يونيو ٢٠٢٦' : 'June 12, 2026'}
        </div>
      </div>
      ...
      <section className="wcr-hero">
        ...
        <div className="wcr-gauge-row">
          ...
          <div className="wcr-gauge-card">
            ...
            <div className="wcr-gauge-card-value gold">{lang === 'ar' ? '٤ نقاط' : '4 pts'}</div>
          ...
          <main>
            ...
            <article className="wcr-article-section">
              ...
              <div className="wcr-pull-quote">
                ...
                <cite>
                  {isRtl 
                    ? 'تقييم دور المجموعات من دزاير أناليتيكا — يونيو ٢٠٢٦' 
                    : 'DZ Analytica Group Stage Assessment — June 2026'}
                </cite>
              </div>
                ...
                <table className="wcr-table">
                  ...
                  <tbody>
                    <tr className="highlight-row">
                      <td><strong>{isRtl ? 'الجزائر' : 'Algeria'}</strong></td>
                      <td>J</td>
                      <td className="result-win">{isRtl ? '٧١.٣٪ (تراكمي ~٩٠٪)' : '71.3% (cumul. ~90%)'}</td>
                      <td>4</td>
                    </tr>
                    <tr>
        ...
        <div className="wcr-overview-grid">
          {teamCards.map((team, idx) => (
            <div key={idx} className="wcr-team-card">
              ...
              <div className={`wcr-team-card-prob ${team.color}`}>{team.prob}</div>
